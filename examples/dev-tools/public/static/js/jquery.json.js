...
var JSONFormat = (function(){
    ...
    loadCssString(
        ...
        '.json_null{color: #f1592a;font-weight:bold; margin-left:5px;}',
        '.json_string{ color: #3ab54a;font-weight:bold; margin-left:5px;}',
        '.json_number{ color: #25aae2;font-weight:bold; margin-left:5px;}',
        '.json_boolean{ color: #f98280;font-weight:bold; margin-left:5px;}',
        '.json_link{ color: #61D2D6;font-weight:bold; margin-left:5px;}',
        '.json_array_brackets{ margin-left:5px;}');
